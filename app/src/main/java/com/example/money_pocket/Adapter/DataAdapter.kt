...
import com.example.money_pocket.Income_Expense_Activity
...
class DataAdapter(val context: Context, var list :ArrayList<IncomeExpenseModel>) : RecyclerView.Adapter<DataAdapter.DataViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DataViewHolder {
        var view = LayoutInflater.from(context).inflate(R.layout.data_style,parent,false)
    ...
    override fun onBindViewHolder(holder: DataViewHolder, position: Int) {
        ...
        holder.txtDataAmount.setOnClickListener{
            var intent = Intent(context,Income_Expense_Activity::class.java)
